...
module walkerFootFrontLowerJoint()
{
    jointLegs = [
            [[0, 90, 0], horizontalPipeInsideDiameter, true, 90, footLowerJointLegLength],
            [[0, 90, walkerFootFrontJointAngle], horizontalPipeInsideDiameter, true, 90, footLowerJointLegLength, [50,
            -(walkerFootFrontJointAngle / 2), 30]],
        // Upright
            [[0, 0, 0], verticalPipeInsideDiameter, false, walkerFootFrontJointAngle - 90, 55, [1, 23, 45]],
        ];
